...
import com.example.miniprojetandroid.USER_ID
import com.example.miniprojetandroid.USER_IMAGE
...
class AddImageToProductFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_add_image_to_product, container, false)
    ...
    private fun addImageToKiosque() {
        ...
        if (body != null) {
            apiInterface.uploadImageToProduct(body,id)
                .enqueue(object : Callback<UploadImageToProductResponse> {
                    override fun onResponse(
                        call: Call<UploadImageToProductResponse>,
                        response: Response<UploadImageToProductResponse>
                    ) {
                        Log.e("kalech",response.toString())
                        Toast.makeText(context, "uploaded", Toast.LENGTH_SHORT).show()
                    }

                    override fun onFailure(call: Call<UploadImageToProductResponse>, t: Throwable) {
